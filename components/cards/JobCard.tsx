...
const toggleDetails = () => {
  ...
  return (
    <div className="p-10 m-5 bg-white border border-gray-300 rounded-lg shadow-md">
      ...
      <p className="flex flex-row items-center justify-center text-sm text-gray-500 text-start">
      <div className='text-yellow-400 rounded-[2px]'>
        <IoHourglassOutline className='w-5 h-5' /></div> Posted {data.postedDate} days ago</p>
      </div>
